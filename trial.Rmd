...
<div id="homeContent">
  <div class="band full blue first rightText">
    ...
    <img class="imageOne" src="img/Myanmar_cluster_blue.png"/>
  </div>
  ...
  <div class="band full gray1 second leftText">
    ...
    <img class="imageTwo" src=img/Myanmar_cluster_blue.png"/>
  </div>

  <div class="band full third rightText">
    <img class="imageThree" src=img/Myanmar_cluster_blue.png"/>
    <div class="bandContent vCenter">
      <div class="blurb">
        <div>
